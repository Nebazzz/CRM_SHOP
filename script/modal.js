...
const createRow = (arrGoods) => {
  ...
  trElement.insertAdjacentHTML('beforeend',
    ` <td class="style-table__body-td">${arrGoods.id}</td>
      <td class="style-table__body-td">${arrGoods.title}</td>
      <td class="style-table__body-td">${arrGoods.category}</td>
      <td class="style-table__body-td">${arrGoods.units}</td>
      <td class="style-table__body-td">${arrGoods.count}</td>
      <td class="style-table__body-td">${arrGoods.price}</td>
      <td class="style-table__body-td">${arrGoods.count * arrGoods.price}</td>
      <td class="style-table__body-td">
        <div class="style-table__body-td-btn td__btn">
